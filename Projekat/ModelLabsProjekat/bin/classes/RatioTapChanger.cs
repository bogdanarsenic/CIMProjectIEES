...
namespace FTN {
    ...
    public class RatioTapChanger : TapChanger {
        ...
        private TransformerEnd cim_TransformerEnd;
        
        private const bool isTransformerEndMandatory = true;
        
        private const string _TransformerEndPrefix = "cim";
        ...
        public virtual TransformerEnd TransformerEnd {
            get {
                return this.cim_TransformerEnd;
            }
            set {
                this.cim_TransformerEnd = value;
            }
        }
        
        public virtual bool TransformerEndHasValue {
            get {
                return this.cim_TransformerEnd != null;
            }
        }
        
        public static bool IsTransformerEndMandatory {
            get {
                return isTransformerEndMandatory;
            }
        }
        
        public static string TransformerEndPrefix {
            get {
                return _TransformerEndPrefix;
            }
        }
    }
}
