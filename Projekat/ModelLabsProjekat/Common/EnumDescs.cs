...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			property2enumType.Add(ModelCode.TERMINAL_PHASE, typeof(PhaseCode));
			property2enumType.Add(ModelCode.RATTAPCHANGER_CONTMODE, typeof(TransformerControlMode));
			property2enumType.Add(ModelCode.POWERTE_CONNKIND, typeof(WindingConnection));														
		}
