...
namespace FTN.Common
{
    ...
    public class ModelResourcesDesc
    {
        ...
        private void InitializeTypeIdsInInsertOrder()
        {
            ...
            typeIdsInInsertOrder.Add(ModelCode.POWERTE);
            typeIdsInInsertOrder.Add(ModelCode.RATTAPCHANGER);
        }
        ...
        private void InitializeNotSettablePropertyIds()
        {
            ...
            notSettablePropertyIds.Add(ModelCode.CONNECTNODE_TERM);
            notSettablePropertyIds.Add(ModelCode.TERMINAL_TRANSEND);
            notSettablePropertyIds.Add(ModelCode.POWERTR_POWTRE);
        }
